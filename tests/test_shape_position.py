...
def test_cylinder_trial_uses_shape_prefixed_identity_and_metadata():
    ...
    assert resolved["variation"]["resolved"]["object_dimensions_m"] == [0.07, 0.07, 0.18]
...
def test_apply_trial_reuses_template_but_changes_task_identity_and_shape():
    ...
    assert configured["pickup"] == {
        ...
        "finger_close_stiffness": 150.0,
        "finger_close_damping": 30.0,
        "tactile_close_step_radians": 0.0001,
        "unilateral_recenter_enabled": True,
        "unilateral_recenter_step": 0.00025,
        "unilateral_recenter_max_correction": 0.02,
        "unilateral_recenter_persistence_frames": 60,
        "bilateral_contact_min_finger_position_radians": -0.001,
        "unilateral_force_limit_newtons": 10.0,
        "unilateral_force_backoff_radians": 0.001,
        "bilateral_force_limit_newtons": 50.0,
        "bilateral_hold_max_force_newtons": 50.0,
        "bilateral_force_backoff_radians": 0.0001,
